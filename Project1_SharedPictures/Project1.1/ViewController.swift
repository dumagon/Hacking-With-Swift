...
class ViewController: UITableViewController {
    ...
    let appURL =  "https://github.com/dumagon/Swift/tree/main/Classic/project1/Project1"
        
        let activityVC = UIActivityViewController(activityItems: ["Check out my app !",appURL], applicationActivities:nil)
